...
from accounting_app.models import InvoiceLineItem, InvoiceRecord
...
from accounting_app.extractor import LLMExtractionAdapter  # noqa: E402
...
class TestSmartInvoiceExtractor(unittest.TestCase):

    def test_smart_extractor_heuristics_fallback_without_keys(self):
        ...
        self.assertEqual(result.values["total_amount"], 1500000.0)
